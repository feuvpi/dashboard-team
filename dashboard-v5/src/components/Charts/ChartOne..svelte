...
>
	<div class="flex flex-wrap items-start justify-between gap-3 sm:flex-nowrap">
		<div class="flex w-full flex-wrap gap-3 sm:gap-5">
			<div class="flex min-w-47.5">
				...
				>
					<span class="block h-2.5 w-full max-w-2.5 rounded-full bg-primary" />
				</span>
				<div class="w-full">
			...
			<div class="flex min-w-47.5">
				...
				>
					<span class="block h-2.5 w-full max-w-2.5 rounded-full bg-secondary" />
				</span>
				<div class="w-full">
	...
	<div>
		<div id="chartOne" class="-ml-5">
			<ReactApexChart {options} series={state.series} type="area" height={350} width={'100%'} />
		</div>
	</div>
</div>
